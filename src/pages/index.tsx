  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen mid-complex-gradient">
      <div className="py-10 px-16 rounded-3xl glass-panel">
        ...
        <p className="text-xl font-medium text-purple-600 mt-4 mb-8 text-center">Paste your link here and click <span className="p-1 rounded-md bg-gray-100 border-white bg-opacity-80 text-purple-500">shrink</span> to shorten your link now!</p>
        <InputForm/>
      </div>
